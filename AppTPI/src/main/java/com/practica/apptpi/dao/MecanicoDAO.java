    ...
    public boolean create(Mecanico mecanico) {
        ...
        try(Connection miConexion = ConectorBD.dameConexion()){
            ...
            try(CallableStatement miSentencia = miConexion.prepareCall(sql)){
                ...
                if (mecanico.getContrasena()== null || mecanico.getContrasena().isEmpty()) { 
                ...
                if(mecanico.getSueldo() <= 0){
                    throw new SQLException("El sueldo es obligatorio");
                }
                ...
                miSentencia.setDouble(7, mecanico.getSueldo());
