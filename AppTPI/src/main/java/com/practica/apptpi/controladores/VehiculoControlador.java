...
public class VehiculoControlador { 
    ...
    public void eliminarVehiculo(Usuario usuarioActual){
        ...
        System.out.println("== ELIMINAR TU VEHICULO ==");
        ...
        if(!vehiculoDAO.verificarTuVehiculo(id, usuarioActual.getDni())){
            System.out.println("No puedes eliminar un vehiculo que no te pertenece");
            return;
        }
        
        if(vehiculoDAO.delete(vehiculo)){
            System.out.println("Cliente \"" + usuarioActual.getNombre() + "\" has eliminado correctamente tu vehiculo");
        }
